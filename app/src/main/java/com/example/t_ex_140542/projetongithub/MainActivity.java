            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.action_favorite:
                        ...
                        Toast toast1 = Toast.makeText(MainActivity.this,"Clique para favorite",Toast.LENGTH_LONG);
                    ...
                    case R.id.action_location:
                        ...
                        Toast toast2 = Toast.makeText(MainActivity.this,"Clique para location ",Toast.LENGTH_LONG);
